...
<div class="container">
    ...
    <div class="logout-section">
        ...
        <p style="color: #666; margin-top: 15px; font-size: 14px;">
            Last login: Today at <?= date('h:i A') ?>
        </p>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateTime() {
            ...
            document.querySelector('.admin-badge .fa-calendar-alt').parentNode.innerHTML = 
        ...
        pendingBadge.className = 'badge bg-danger';
        ...
        pendingBadge.textContent = '5';
        
        // Add to leave requests card
        ...
        statCards.forEach(card => {
            ...
            card.addEventListener('click', function() {
                ...
                if (label.includes('Employees')) {
                    ...
                    window.location.href = '../admin/attendance.php';
                } else if (label.includes('Pending')) {
                    window.location.href = '../admin/leave_requests.php';
                } else if (label.includes('Leave')) {
                    window.location.href = '../admin/leave_requests.php';
                }
            });
        });
